...
def main(corpus_file_name):
    ...
    for target_word in target_words:
        similar_words[target_word].append(sentence.get_most_similarity_words(target_words))
        similar_words[target_word].append(window.get_most_similarity_words(target_words))
        similar_words[target_word].append(dependency_edge.get_most_similarity_words(target_words))
